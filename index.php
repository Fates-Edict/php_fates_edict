...
<head>
    ...
    <title>Teramedik Soal A - PHP</title>
...
<body>
    <div class="h-screen w-screen flex items-center justify-center">
        <div class="h-[50%] text-center flex flex-col gap-5 border border-gray-300 p-10 rounded bg-white">
            ...
            <p>Programmed by <a class="font-bold text-blue-500 underline" target="_blank" href="https://www.linkedin.com/in/mutaqin-yusuf/">Mutaqin Yusuf</a></p>
        </div>
    </div>
</body>
</html>